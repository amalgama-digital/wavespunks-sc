...
(async () => {
    ...
    //     fee: 1000000,
    // }, dappSeed);
    // await broadcast(punkSupplyTx);
    // await waitForTx(punkSupplyTx.id)
    // console.log('total supply was added')

    // const availablePunksTx = data({
    //     data: [{
    //         type: 'string',
    //         key: 'available_punks',
    //         value: avilavle_punks,
    //     }],
    //     fee: 1000000,
    // }, dappSeed);
    // await broadcast(availablePunksTx);
    ...
    //     fee: 1000000,
    // }, dappSeed);
    // await broadcast(startMintTx);
    // await waitForTx(startMintTx.id)
    // console.log('Start_mint was added')

    const gifDataTx = data({
        data: [{
            type: 'string',
            key: 'gif_punk',
            value: gif_punks,
